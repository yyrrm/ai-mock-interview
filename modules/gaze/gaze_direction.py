...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            try:
                ...
                # 5. 보정값과의 차이
                diff_x = current_metric_x - calibrated_metric_x
                diff_y = current_metric_y - calibrated_metric_y
    ...
    calib_text_size = cv2.getTextSize(calib_instruction, FONT, FONT_SCALE_CALIB, FONT_THICKNESS_CALIB)[0]
